...
g2 = ['%g' %(200*(i+1)) for i in range(5)]
print g2

def fit(line):
  filename = 'comb_g2_20_LW_0.7GHz_%suWcm2_1e-10_conS_10_O=12_N1_10_N2_600_D_0MHz_S.txt' %line
  print filename
  #filename = sys.argv[1]
  ...
  savefig('comb_g2_20_LW_0.7GHz_%suWcm2_1e-10_conS_10_O=12_N1_10_N2_600_D_0MHz_S.png'%line) 
  clf()
  p1[0]=p1[0]/1e10
  p1[1]=p1[1]/1e5
  p1[2]=p1[2]/1e5
...
ll = ['detune(uW)\t','y_offset\t','x_offset(Hz)\t','width(Hz)\t','peak\t']
